...
const levels = {
    entry_hall: [
        ...
        [ {type: 'wall', mats: ['brick_mat']},
            { type: 'space', mats: ['mat3', 'mat2'], desc: 'The floor is a different color.',
                extra: { object: { type: 'pickup', desc: "There's something here..", mats: ['revolver'],
                    extra: { name: 'Revolver', equips_to: 'right_hand' } } }  },
            { type: 'wall', mats: ['brick_mat'] } ],
        [ {type: 'wall', mats: ['brick_mat']}, { type: 'space', mats: ['pavement_mat', 'mat2']  },
            { type: 'wall', mats: ['brick_mat'] } ],
        [ {type: 'wall', mats: ['brick_mat']}, { type: 'space', mats: ['pavement_mat', 'mat2'] },
            { type: 'wall', mats: ['brick_mat'] }, { type: 'wall', mats: ['brick_mat'] },
            { type: 'wall', mats: ['brick_mat'] } ],
        [ {type: 'wall', mats: ['brick_mat']}, { type: 'space', mats: ['pavement_mat', 'mat2'] },
            { type: 'space', mats: ['pavement_mat', 'mat2'] }, { type: 'space', mats: ['pavement_mat', 'mat2'] },
            { type: 'space', mats: ['pavement_mat', 'mat2'] },
    ...
    forest: [
        ...
        [ {"type":"wall","mats":["treewall_mat",null] },
            {"type":"space","mats":["grass_mat","mat3"] },
            {"type":"space","mats":["grass_mat","mat3"] },
            {"type":"space","mats":["grass_mat","mat3"] },
            {"type":"space","mats":["grass_mat","mat3"] },
            {"type":"wall","mats":["treewall_mat",null] } ],
        [ {"type":"wall","mats":["treewall_mat",null] },
            {"type":"space","mats":["grass_mat","mat3"]},
            {"type":"space","mats":["grass_mat","mat3"], extra: { object: { type: 'tall', mats: ['tall_mat'],
                    extra: { solid: true } } } },
            {"type":"space","mats":["grass_mat","mat3"], extra: { object: { type: 'tall', mats: ['tall_mat'],
                    extra: { solid: true }} } },
            {"type":"space","mats":["grass_mat","mat3"] },
        ...
        [ {"type":"wall","mats":["treewall_mat",null] },
            {"type":"space","mats":["grass_mat","mat3"] },
            {"type":"space","mats":["grass_mat","mat3"] },
            {"type":"space","mats":["grass_mat","mat3"], extra: { object: {
                    type: 'ai', mats: ['dude_mat'] } } },
            {"type":"space","mats":["grass_mat","mat3"] },
            {"type":"wall","mats":["treewall_mat",null] } ],
