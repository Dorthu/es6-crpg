...
const levels = {
    entry_hall: [
        ...
        [ {type: 'wall', mats: ['wallpaper_top']},
            { type: 'enclosed', mats: ['woodfloor_rug','ceiling'], desc: 'The floor is a different color.',
                extra: { object: { type: 'pickup', desc: "There's something here..", mats: ['key'],
                    extra: { name: 'Key' } } }  },
            { type: 'wall', mats: ['wallpaper_top'] } ],
        [ {type: 'wall', mats: ['wallpaper_top']}, { type: 'enclosed', mats: ['woodfloor','ceiling', 'debug-2']  },
            { type: 'wall', mats: ['wallpaper_top'] } ],
        [ {type: 'wall', mats: ['wallpaper_tear']}, { type: 'enclosed', mats: ['woodfloor','ceiling', 'debug-2'] },
            { type: 'wall', mats: ['wallpaper_top'] }, { type: 'wall', mats: ['wallpaper_top'] },
            { type: 'wall', mats: ['wallpaper_top'] } ],
        [ {type: 'wall', mats: ['wallpaper_top']}, { type: 'enclosed', mats: ['woodfloor','ceiling', 'debug-2'] },
            { type: 'enclosed', mats: ['woodfloor','ceiling', 'debug-2'] }, { type: 'enclosed', mats: ['woodfloor','ceiling', 'debug-2'] },
            { type: 'enclosed', mats: ['woodfloor','ceiling', 'debug-2'] },
    ...
    entry_hall_update: [[null,{"type":"wall","mats":["brick"]}],
        ...
        {"type":"space","mats":["debug-2","debug-2"]},{"type":"wall","mats":["brick"]}],
        [{"type":"door","mats":["debug-door"], extra: { to: 'ai_test', player_pos: { x: 1, z: 2 }, player_facing: 3 } },{"type":"space","mats":["sidewalk","debug-2"]},{"type":"wall","mats":["brick"]}],
        [{"type":"wall","mats":["brick"]},{"type":"space","mats":["sidewalk","debug-2"]},{"type":"wall","mats":["brick"]},{"type":"wall","mats":["brick"]},{"type":"wall","mats":["brick"]},null,null,null,{"type":"wall","mats":["brick","debug-2"]},{"type":"wall","mats":["brick","debug-2"]},
                {"type":"door","mats":["debug-door","debug-2"],
                    extra: { to: 'outdoors', player_pos: { x: 1, z: 0 }, player_facing: 0 }}],
    ...
    ai_test: [[],[null,{"type":"wall","mats":["wallpaper_top","ceiling"]},
            {"type":"wall","mats":["wallpaper_top","ceiling"]},
            {"type":"wall","mats":["wallpaper_tear","ceiling"]},
            {"type":"wall","mats":["wallpaper_top","ceiling"]},
            {"type":"wall","mats":["wallpaper_top","ceiling"]},
            {"type":"wall","mats":["wallpaper_tear","ceiling"]},
            {"type":"wall","mats":["wallpaper_top","ceiling"]},
        ...
        [{"type":"door","mats":["wallpaper_door",null], extra:
            { to: 'entry_hall_update', player_pos: { x: 1, z: 2 }, player_facing: 3 } },
            ...
            {"type":"enclosed","mats":["woodfloor","ceiling"]},
            {"type":"enclosed","mats":["woodfloor","ceiling"]},
            {"type":"wall","mats":["wallpaper_window","ceiling"]}],
        [{"type":"wall","mats":["wallpaper_top","ceiling"]},
            {"type":"enclosed","mats":["woodfloor","ceiling"]},
            {"type":"wall","mats":["wallpaper_top","ceiling"]},
            {"type":"enclosed","mats":["woodfloor","ceiling"],
        ...
        [{"type":"wall","mats":["wallpaper_tear","ceiling"]},
            ...
            {"type":"enclosed","mats":["woodfloor","ceiling"]},
            {"type":"wall","mats":["wallpaper_top","ceiling"]}],
        [null,{"type":"wall","mats":["wallpaper_top","ceiling"]},
            {"type":"wall","mats":["wallpaper_top","ceiling"]},
            {"type":"wall","mats":["wallpaper_top","ceiling"]},
            {"type":"wall","mats":["wallpaper_top","ceiling"]},
            {"type":"enclosed","mats":["woodfloor","ceiling"]},
            ...
            {"type":"enclosed","mats":["woodfloor","ceiling"]},
            {"type":"wall","mats":["wallpaper_window","ceiling"]}],
        [null,null,null,null,null,{"type":"wall","mats":["wallpaper_top","ceiling"]},
            {"type":"wall","mats":["wallpaper_tear","ceiling"]},
            {"type":"wall","mats":["wallpaper_top","ceiling"]},
            {"type":"wall","mats":["wallpaper_top","ceiling"]},
            {"type":"wall","mats":["wallpaper_top","ceiling"]},
            {"type":"wall","mats":["wallpaper_tear","ceiling"]},
            {"type":"wall","mats":["wallpaper_top","ceiling"]}]],
        outdoors: [[null,{"type":"wall","mats":["treewall",null]},
                    {"type":"wall","mats":["treewall",null]},
                    {"type":"wall","mats":["treewall",null]},
                    {"type":"wall","mats":["treewall",null]},
                    {"type":"wall","mats":["treewall",null]},
                    {"type":"wall","mats":["brick",null]},
                    {"type":"wall","mats":["brick",null]}],
            [{"type":"wall","mats":["treewall",null]},
                    {"type":"space","mats":["grass",null]},
                    {"type":"space","mats":["grass",null]},
                    {"type":"space","mats":["grass",null]},
                    {"type":"space","mats":["grass",null]},
                    {"type":"wall","mats":["treewall",null]},
                    {"type":"space","mats":["pavement",null]},
                    {"type":"space","mats":["pavement_grass",null],"extra":{"object":{"type":"tall", mats: ["tall"]}}},
                    {"type":"wall","mats":["brick",null]}],
            [{"type":"wall","mats":["treewall",null]},
                    {"type":"space","mats":["sidewalk",null]},
                    {"type":"space","mats":["sidewalk",null]},
                    {"type":"space","mats":["sidewalk",null]},
                    {"type":"space","mats":["sidewalk",null]},
                    {"type":"space","mats":["sidewalk",null]},
                    {"type":"space","mats":["sidewalk",null]},
                    {"type":"space","mats":["sidewalk",null]},
                    {"type":"door","mats":["brick_door",null]}],
            [{"type":"wall","mats":["treewall",null]},
                    {"type":"space","mats":["sidewalk",null]},
                    {"type":"space","mats":["grass",null]},
                    {"type":"space","mats":["grass",null]},
                    ...
                    {"type":"wall","mats":["treewall",null]},
                    {"type":"wall","mats":["brick",null]}],
            [null,{"type":"door","mats":["brick_door",null]},
                    {"type":"wall","mats":["brick",null]},
                    {"type":"wall","mats":["treewall",null]},
                    {"type":"wall","mats":["treewall",null]},
                    {"type":"wall","mats":["treewall",null]},
